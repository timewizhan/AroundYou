...
enum E_PROTOCOL_REQUEST_TYPE
{
	...
	*/
	...
	/*
		Stores
	*/
	E_PROTO_REQ_HEADER_STORES,
	E_PROTO_REQ_DATA_STORES,

	/*
		Menus
	*/
	E_PROTO_REQ_HEADER_MENUS,
	E_PROTO_REQ_DATA_MENUS,
...
enum E_PROTOCOL_RESPONSE_TYPE
{
	...
	*/
	...
	/*
		Stores
	*/
	E_PROTO_RES_DATA_STORES_NOT_EXIST,

	/*
		Menus
	*/
	E_PROTO_RES_DATA_MENUS_NOT_EXIST,
